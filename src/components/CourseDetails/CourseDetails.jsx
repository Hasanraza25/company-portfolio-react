    ...
    return (
      <Fragment>
        <Container className="mt-5">
          <Row>
            <Col lg={8} md={6} sm={12}>
              <h1 className="coruseDetailsText">
                {" "}
              ...
              <p className="CoruseallDescription">
                ...
                vex bold Jim. Quick zephyrs blow, vexing daft Jim. <br></br>{" "}
                <br></br>Sex-charged fop blew my junk TV quiz. How quickly daft
                jumping zebras vex. Two driven jocks help fax my big quiz.
                Quick, Baz, get my woven flax jodhpurs! "Now fax quiz Jack!" my
                brave ghost pled. Five quacking zephyrs jolt my wax bed.
                Flummoxed by job, kvetching W. zaps Iraq. <br></br> <br></br>
                ...
                <ul>
                  ...
                  <li>
                    <FontAwesomeIcon
                      ...
                      icon={faCheckSquare}
                    />{" "}
                    <span>Instructor:</span> Ayaz Ahmed Mast
                  </li>
                </ul>
